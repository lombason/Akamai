...
sMLEPrint(){
  ...
  printf "Go to: \r https://www.netarch.akamai.com/sql/lranchev/core_smle_region_check_in_ecor?region=$TARGETS \r
  Take appropriate actions depending on the answer received:

  1. If the whole ECOR will be deconstructed all at once, then you can proceed with this deconstruction and continue with the rest of the procedure below

  2. If the region deconstruction is specific to this region only or a partial-ECOR deconstruction and the ECOR will continue to serve traffic, then please ask the DP requestor to follow the Planning SMLE ECOR/Region Deconstruction Procedure and cancel the deconstruction" > $TICKET.tix;
